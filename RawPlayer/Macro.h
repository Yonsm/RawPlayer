...
#define EXECUTE						__except (EXCEPTION_EXECUTE_HANDLER)
#else
#define TRY
#define FINALLY
#define EXCEPT
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 对齐分配
#define _AlignAlloc					_aligned_malloc
#define _AlignFree					_aligned_free
#define _SafeAlignFree(p)			if (p) {_AlignFree(p); p = NULL;}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
